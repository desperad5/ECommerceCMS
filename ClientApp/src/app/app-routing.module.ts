...
const routes: Routes = [
...

	{
		...
		children: [
			...
			{
				path: 'listing',
				loadChildren: () => import('../app/views/pages/listing/listing.module').then(m => m.ListingModule),
			},
			{
			...
			{
				path: 'tenant',
				loadChildren: () => import('../app/views/pages/tenant/tenant.module').then(m => m.TenantModule),
			},
			{
				path: 'brand',
				loadChildren: () => import('../app/views/pages/brand/brand.module').then(m => m.BrandPageModule),
			},
			{
				path: 'lesson',
				loadChildren: () => import('../app/views/pages/lesson/lesson.module').then(m => m.LessonModule),
			},
			{
				path: 'topics',
				loadChildren: () => import('../app/views/pages/topic/topic.module').then(m => m.TopicModule),
			},
			{
				path: 'card',
				loadChildren: () => import('../app/views/pages/cards/cards.module').then(m => m.CardsModule),
			},
			{
				path: 'mail',
