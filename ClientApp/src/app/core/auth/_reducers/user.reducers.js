...
function usersReducer(state, action) {
    ...
    switch (action.type) {
        case user_actions_1.UserActionTypes.UsersPageToggleLoading: return __assign(__assign({}, state), { listLoading: action.payload.isLoading, lastCreatedUserId: undefined });
        case user_actions_1.UserActionTypes.UsersActionToggleLoading: return __assign(__assign({}, state), { actionsloading: action.payload.isLoading });
        case user_actions_1.UserActionTypes.UserOnServerCreated: return __assign({}, state);
        case user_actions_1.UserActionTypes.UserCreated: return exports.adapter.addOne(action.payload.user, __assign(__assign({}, state), { lastCreatedUserId: action.payload.user.id }));
        ...
        case user_actions_1.UserActionTypes.UsersPageCancelled: return __assign(__assign({}, state), { listLoading: false, lastQuery: new crud_1.QueryParamsModel({}) });
