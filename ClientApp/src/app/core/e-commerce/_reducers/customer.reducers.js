...
function customersReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case customer_actions_1.CustomerActionTypes.CustomerCreated: return exports.adapter.addOne(action.payload.customer, __assign(__assign({}, state), { lastCreatedCustomerId: action.payload.customer.id }));
