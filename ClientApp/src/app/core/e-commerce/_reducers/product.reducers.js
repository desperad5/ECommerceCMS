...
function productsReducer(state, action) {
    ...
    switch (action.type) {
        case product_actions_1.ProductActionTypes.ProductsPageToggleLoading: return __assign(__assign({}, state), { listLoading: action.payload.isLoading, lastCreatedProductId: undefined });
        case product_actions_1.ProductActionTypes.ProductsActionToggleLoading: return __assign(__assign({}, state), { actionsloading: action.payload.isLoading });
        case product_actions_1.ProductActionTypes.ProductOnServerCreated: return __assign({}, state);
        case product_actions_1.ProductActionTypes.ProductCreated: return exports.adapter.addOne(action.payload.product, __assign(__assign({}, state), { lastCreatedProductId: action.payload.product.id }));
        ...
        case product_actions_1.ProductActionTypes.ProductsPageCancelled: return __assign(__assign({}, state), { listLoading: false, lastQuery: new crud_1.QueryParamsModel({}) });
